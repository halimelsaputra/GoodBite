...
const Login = () => {
  ...
  useEffect(() => {
    ...
    if (sellerUser) {
      toast.error("Anda sudah login sebagai penjual. Silakan logout terlebih dahulu untuk login sebagai pembeli.");
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      orderService.switchUser(result.user.phone);
      ...
      <main className="flex-1 flex items-center justify-center py-24 md:py-32 relative overflow-hidden">
        ...
        <div className="container relative z-10 max-w-lg">
          <div className="shadow-input mx-auto w-full rounded-none bg-white p-4 md:rounded-2xl md:p-8 dark:bg-black">
            <h2 className="text-xl font-bold text-neutral-800 dark:text-neutral-200">Masuk ke GoodBite</h2>
            <p className="mt-2 max-w-sm text-sm text-neutral-600 dark:text-neutral-300">
              Masuk untuk mulai berhemat dan selamatkan makanan favoritmu.
            </p>
