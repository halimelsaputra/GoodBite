...
const PaketDetail = () => {
  ...
  useEffect(() => {
    const loadReviews = async () => {
      if (!id) return;
      try {
        const data = await AuthService.getPackageReviews(id);
        setReviews(data);
      } catch (error) {
                      ...
                      <div className="pt-4 border-t space-y-4">
                        ...
                        <div className="bg-primary/5 rounded-2xl p-4 space-y-2">
                          ...
                          <ul className="text-sm text-muted-foreground space-y-1 ml-4">
                            <li>â€¢ Roti dan pastry berbagai jenis</li>
                            <li>â€¢ Kue dan dessert premium</li>
                            <li>â€¢ Sandwich atau snack</li>
                          </ul>
                  ...
                  <Card className="border-none shadow-lg">
                    <CardContent className="p-6">
                      ...
                      <div className="flex items-center gap-8 pb-6 border-b mb-6">
                        <div className="text-center">
                          ...
                          <p className="text-sm text-muted-foreground">
                            {isLoadingReviews ? "Memuat..." : `${totalReviews} ${totalReviews === 1 ? "ulasan" : "ulasan"}`}
                          </p>
                        </div>
                      ...
                      <div className="space-y-4">
                        {isLoadingReviews && <p className="text-muted-foreground">Memuat ulasan...</p>}
                  ...
                  {timeLeft.hours < 24 && (
                    <Card className="border-2 border-accent bg-gradient-to-br from-accent/10 to-accent/5">
                      <CardContent className="p-6 text-center">
                        <p className="text-sm font-medium mb-2">â° Ambil Hari Ini!</p>
